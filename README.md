...
[Link to Hello-Rails-back-end](https://github.com/svitalis123/hello-rails-back-end/)
(https://github.com/svitalis123/hello-rails-back-end/)
**[Hello-React-Front-end]** Hello-rails-Front-end is a React app that renders 5 different greetings in a Postgres database. 
